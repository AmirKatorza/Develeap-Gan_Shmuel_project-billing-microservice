...
# Configure database
db_config = yaml.load(open('db/multi-db/billdb.yaml'), Loader=yaml.FullLoader)
DATABASE_URL = f"mysql+mysqlconnector://{db_config['mysql_user']}:{db_config['mysql_password']}@{db_config['mysql_host']}/{db_config['mysql_db']}"
